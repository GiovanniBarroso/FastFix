<template>
  ...
  const buscarGarantia = () => {
    console.log('Buscando garantía para pedido:', form.value.pedido)
  
    // Simulación de búsqueda de garantía
    if (form.value.pedido === '12345') {
      garantia.value = {
        fechaFin: '31/12/2025',
        detalles: 'Reparación de pantalla - iPhone 13 Pro'
      }
    } else {
      garantia.value = null
    }
