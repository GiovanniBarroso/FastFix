    ...
    <section class="py-20 bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800 min-h-screen">
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="text-center mb-12">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-300">Consulta tus solicitudes de presupuesto y su estado.</p>
        </div>
          ...
          <table class="min-w-full text-sm text-gray-800 dark:text-gray-100">
            <thead class="bg-blue-600 text-white">
              <tr>
                ...
                <th class="text-left px-6 py-4">Fecha solicitud</th>
                <th class="text-left px-6 py-4">Mensaje</th>
                <th class="text-left px-6 py-4">Estado</th>
                <th class="text-left px-6 py-4">Respuesta</th>
                <th class="text-left px-6 py-4">Presupuesto estimado</th>
              </tr>
            </thead>
            <tbody>
              <tr
              ...
              >
                ...
                <td class="px-6 py-4 max-w-xs whitespace-pre-line break-words">{{ budget.mensaje }}</td>
                <td class="px-6 py-4">
                  <span :class="['px-3 py-1 text-xs font-semibold rounded-full capitalize', estadoColor(budget.estado)]">
                    {{ traducirEstado(budget.estado) }}
                  </span>
                </td>
                <td class="px-6 py-4 text-gray-700 dark:text-gray-300">
                  {{ budget.respuesta_admin || '—' }}
                </td>
                <td class="px-6 py-4">
                  {{ budget.presupuesto_estimado ? `€${parseFloat(budget.presupuesto_estimado).toFixed(2)}` : '—' }}
                </td>
